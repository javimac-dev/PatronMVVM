...
{
    public class VMPatron/*-> cambia por el nombre del nuevo VM*/: BaseViewModel //heredado de la clase BaseViewModel
    {
        #region VARIABLES
        string _Texto;
        #endregion
        ...
        #region CONSTRUCTOR
        public VMPatron/*-> cambia por el nombre del nuevo VM*/(INavigation navigation)
        {
